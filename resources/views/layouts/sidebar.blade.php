<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Website Pages -->
    <li class="menu-item {{ request()->is('home') || request()->is('about') || request()->is('services') || request()->is('people') || request()->is('careers') || request()->is('international') || request()->is('contact') ? 'active open' : '' }}">
