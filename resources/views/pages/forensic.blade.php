...
@section('title', 'Forensic & Litigation Content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1" style="font-size: 1.5rem; font-weight: bold;">Forensic & Litigation Support</h5>
                    <small class="text-muted" style="font-size: 1rem;">Manage forensic & litigation page content</small>
                </div>
                <a href="{{ route('admin.forensic.edit') }}" class="btn btn-sm btn-primary">Edit</a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'forensic_service_image')->first();
                    @endphp
                    <tr>
                    ...
                    <!-- Services Title -->
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'forensic_services_title')->first();
                    @endphp
                    <tr>
                    ...
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'forensic_cta_text')->first();
                    @endphp
                    <tr>
