...
@section('title', 'Business Advisory Content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1" style="font-size: 1.5rem; font-weight: bold;">Business Advisory Page</h5>
                    <small class="text-muted" style="font-size: 1rem;">Manage business advisory page content</small>
                </div>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'advisory_service_image')->first();
                    @endphp
                    <tr>
                    ...
                    <!-- Services Title -->
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'advisory_services_title')->first();
                    @endphp
                    <tr>
                    ...
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'advisory_cta_text')->first();
                    @endphp
                    <tr>
