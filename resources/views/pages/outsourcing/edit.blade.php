...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('admin.outsourcing.update') }}" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="outsourcing_value_title" class="form-label">Value Proposition Title</label>
                    <input type="text" name="outsourcing_value_title" id="outsourcing_value_title" class="form-control"
                        value="{{ old('outsourcing_value_title', $outsourcing_value_title) }}" required>
                </div>

                <div class="mb-3">
                    <label for="outsourcing_value_description" class="form-label">Value Proposition Description</label>
                    <textarea name="outsourcing_value_description" id="outsourcing_value_description" rows="4" class="form-control"
                        required>{{ old('outsourcing_value_description', $outsourcing_value_description) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="outsourcing_cta_text" class="form-label">CTA Button Text</label>
                    <input type="text" name="outsourcing_cta_text" id="outsourcing_cta_text" class="form-control"
                        value="{{ old('outsourcing_cta_text', $outsourcing_cta_text) }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="outsourcing_sidebar_cta_title" class="form-label">Sidebar CTA Title</label>
                    <input type="text" name="outsourcing_sidebar_cta_title" id="outsourcing_sidebar_cta_title" class="form-control"
                        value="{{ old('outsourcing_sidebar_cta_title', $outsourcing_sidebar_cta_title) }}" required>
                </div>

                <div class="mb-3">
                    <label for="outsourcing_sidebar_cta_description" class="form-label">Sidebar CTA Description</label>
                    <textarea name="outsourcing_sidebar_cta_description" id="outsourcing_sidebar_cta_description" rows="3" class="form-control"
                        required>{{ old('outsourcing_sidebar_cta_description', $outsourcing_sidebar_cta_description) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="outsourcing_sidebar_cta_button_text" class="form-label">Sidebar CTA Button Text</label>
                    <input type="text" name="outsourcing_sidebar_cta_button_text" id="outsourcing_sidebar_cta_button_text" class="form-control"
                        value="{{ old('outsourcing_sidebar_cta_button_text', $outsourcing_sidebar_cta_button_text) }}" required>
                </div>
            </div>
        </div>
