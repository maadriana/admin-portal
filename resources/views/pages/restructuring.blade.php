        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <!-- Services Title -->
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'restructuring_services_title')->first();
                    @endphp
                    <tr>
                    ...
                    @php
                        $item = \App\Models\Content::with('editor')->where('key', 'restructuring_cta_text')->first();
                    @endphp
                    <tr>
