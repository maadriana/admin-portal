...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('admin.advisory.update') }}" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                @php
                    $advisoryServiceImage = \App\Models\Content::where('key', 'advisory_service_image')->first();
                @endphp

                @if($advisoryServiceImage && $advisoryServiceImage->image)
                <div class="mb-2">
                    <img src="data:image/jpeg;base64,{{ base64_encode($advisoryServiceImage->image) }}" alt="Service Image"
                        class="img-thumbnail" style="max-width: 300px;">
                </div>
                @endif

                <input type="file" name="advisory_service_image" id="advisory_service_image" class="form-control mt-2">
                <small class="form-text text-muted">Recommended size: 800x300px</small>

                @if($advisoryServiceImage && $advisoryServiceImage->image)
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" name="remove_advisory_service_image" id="remove_advisory_service_image" value="1">
                    <label class="form-check-label text-danger" for="remove_advisory_service_image">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="advisory_overview_paragraph1" class="form-label">Overview Paragraph 1</label>
                    <textarea name="advisory_overview_paragraph1" id="advisory_overview_paragraph1" rows="3" class="form-control"
                        required>{{ old('advisory_overview_paragraph1', $advisory_overview_paragraph1) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="advisory_overview_paragraph2" class="form-label">Overview Paragraph 2</label>
                    <textarea name="advisory_overview_paragraph2" id="advisory_overview_paragraph2" rows="3" class="form-control"
                        required>{{ old('advisory_overview_paragraph2', $advisory_overview_paragraph2) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="advisory_value_title" class="form-label">Value Proposition Title</label>
                    <input type="text" name="advisory_value_title" id="advisory_value_title" class="form-control"
                        value="{{ old('advisory_value_title', $advisory_value_title) }}" required>
                </div>

                <div class="mb-3">
                    <label for="advisory_value_description" class="form-label">Value Proposition Description</label>
                    <textarea name="advisory_value_description" id="advisory_value_description" rows="4" class="form-control"
                        required>{{ old('advisory_value_description', $advisory_value_description) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="advisory_cta_text" class="form-label">CTA Button Text</label>
                    <input type="text" name="advisory_cta_text" id="advisory_cta_text" class="form-control"
                        value="{{ old('advisory_cta_text', $advisory_cta_text) }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="advisory_sidebar_cta_title" class="form-label">Sidebar CTA Title</label>
                    <input type="text" name="advisory_sidebar_cta_title" id="advisory_sidebar_cta_title" class="form-control"
                        value="{{ old('advisory_sidebar_cta_title', $advisory_sidebar_cta_title) }}" required>
                </div>

                <div class="mb-3">
                    <label for="advisory_sidebar_cta_description" class="form-label">Sidebar CTA Description</label>
                    <textarea name="advisory_sidebar_cta_description" id="advisory_sidebar_cta_description" rows="3" class="form-control"
                        required>{{ old('advisory_sidebar_cta_description', $advisory_sidebar_cta_description) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="advisory_sidebar_cta_button_text" class="form-label">Sidebar CTA Button Text</label>
                    <input type="text" name="advisory_sidebar_cta_button_text" id="advisory_sidebar_cta_button_text" class="form-control"
                        value="{{ old('advisory_sidebar_cta_button_text', $advisory_sidebar_cta_button_text) }}" required>
                </div>
            </div>
        </div>
